	...
	$.alerts = {
		...
		_show: function(msg, value, ok, cancel, type, callback) {
			...
			switch( type ) {
				...
				break;
				case 'prompt':
					$("#popup_message").append('<br /><textarea rows="5" cols="30" id="popup_prompt" style="resize: none;" maxlength="250"></textarea>').after('<div id="popup_panel"><input type="button" value="' + ok + '" id="popup_ok" /> <input type="button" value="' + cancel + '" id="popup_cancel" /></div>');
